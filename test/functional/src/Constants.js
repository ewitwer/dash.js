...
TESTCASES.DODGE.QUALITY_SWITCH = TESTCASES.CATEGORIES.DODGE + 'quality-switch';
...
TESTCASES.DODGE.TRAILING_COMPLETION = TESTCASES.CATEGORIES.DODGE + 'trailing-completion';
TESTCASES.DODGE.PROGRESSIVE = TESTCASES.CATEGORIES.DODGE + 'progressive';
TESTCASES.DODGE.REQUEST_PADDING = TESTCASES.CATEGORIES.DODGE + 'request-padding';
TESTCASES.DODGE.SOURCE_SWITCH = TESTCASES.CATEGORIES.DODGE + 'source-switch';
